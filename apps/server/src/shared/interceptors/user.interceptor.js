...
var UserInterceptor = /** @class */ (function () {
    ...
    UserInterceptor.prototype.intercept = function (context, next) {
        return __awaiter(this, void 0, void 0, function () {
            var req, user, username, userId, userContext;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, next.handle().pipe((0, operators_1.tap)(function () {
    ...
    UserInterceptor = __decorate([
        ...
        __param(0, (0, common_1.Inject)(types_1.TYPES.DB.PrismaService)),
        __param(1, (0, common_1.Inject)(types_1.TYPES.DB.RedisService))
    ], UserInterceptor);
