...
type UseFormInputReturn<TFormFieldProps extends object, TFieldValues extends FieldValues> = Omit<
 ...
 */
export const useFormInputProps = <TFormFieldProps extends object, TFieldValues extends FieldValues>(
  props: UseFormInputProps<TFormFieldProps, TFieldValues>,
): UseFormInputReturn<TFormFieldProps, TFieldValues> => {
  const { control, defaultValue, name, rules, shouldUnregister, ...inputProps } = props;
